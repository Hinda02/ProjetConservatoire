...
<div class="sm:ml-40 ">
<form class="mt-30 ml-60 w-full max-w-lg flex-col" action="index.php?uc=eleve&action=valideAjout" method="post">
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      ...
      <input name="nom" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Jane">
    </div>
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full px-3">
      ...
      <input name="mail" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="email" placeholder="user@example.me">
    </div>
  </div>
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    ...
    <div class="flex ml-5 md:w-2/3">
      <button class="shadow bg-orange-400 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
        Ajouter
      </button>
    </div>
