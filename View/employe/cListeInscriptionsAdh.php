...
<div class="sm:ml-40">
    <div class="flex items-center justify-between p-4 bg-white dark:bg-gray-900">
        ...
        <form class="flex items-center" action="index.php?uc=&action=" method="post">
            ...
            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
             ...
             <input type="text" name="" id="table-search-users" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Rechercher un cours">
            ...
            foreach ($lesInscriptions as $inscription) {
                ...
                echo '<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <div class="pl-3">
                                    <div class="text-base font-semibold">'.$lesProfs[$inscription->IDPROF]->INSTRUMENT.'</div>
                                    <div class="font-normal text-gray-500">Professeur: '.$lesProfs[$inscription->IDPROF]->NOM.' '.$lesProfs[$inscription->IDPROF]->PRENOM.'</div>
                                </div>  
                            </th>
                            <td class="px-6 py-4">
                                '.$lesProfs[$inscription->IDPROF]->TEL.'
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="mt-4 mr-0 mb-0 ml-0 pt-0 pr-0 pb-0 pl-14 flex items-center sm:space-x-6 sm:pl-0 sm:mt-0">
                                    <a class="flex items-center bg-red-500 h-12 px-3 mt-2 rounded hover:bg-gray-300" href="index.php?uc=inscriptions&action=supprimer&idprof='.$inscription->IDPROF.'&ideleve='.$inscription->IDELEVE.'&nums='.$inscription->NUMSEANCE.'">
                                        ...
                                        <span class="ml-3 text-black text-sm font-medium">Supprimer</span>
                                    </a>
                                </div>
                            </td>
