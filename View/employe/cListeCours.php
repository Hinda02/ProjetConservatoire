...
<div class="sm:ml-40">
    <div class="flex items-center justify-between p-4 bg-white">
        ...
        <form class="flex items-center" action="index.php?uc=cours&action=recherche" method="post">
            ...
            <input type="text" name="rechercher" class="flex block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Rechercher un cours"></input>
            
            <button class="flex ml-2 shadow bg-orange-400 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-1 px-2 rounded" type="submit">
                Chercher
            </button>  
        </form>
