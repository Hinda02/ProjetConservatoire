<!-- Component Start -->
<div class="flex flex-col fixed z-10 top-0 left-0 transition-transform -translate-x-full sm:translate-x-0 items-center w-40 h-screen overflow-hidden text-gray-700 bg-indigo-400 rounded">
		...
		<div class="w-full px-2">
			<div class="flex flex-col items-center w-full mt-3 border-t border-gray-300">
				...
				<a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-300" href="#">
					...
					<span class="ml-2 text-sm font-medium">Rechercher</span>
				</a>
				...
				<a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="index.php?uc=ajouterAdherent">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
